...
| 3 | Remote branches `main` and `blindspots-frontier-models-ibm-granite` point to the **same commit** | PASS | `git ls-remote` shows the same SHA for both refs |
...
# <SAME_SHA>  refs/heads/blindspots-frontier-models-ibm-granite
# <SAME_SHA>  refs/heads/main
```
